...
//CHALLENGE
*console.log(`episode number: ${netflix.season1.seasonInfo.episodeInfo[4].episode} -episode name: ${netflix.season1.episodeInfo[4].episodeName}`);


/*
    - JSON stands for JavaScript Object Notation
    - JSON syntax is derived from JS object syntax but JSON data is in a text only format.
    - JSON exists as a string, and needs to be convereted to a native JS object if we want to access the data.
*/
...
/*
    ...
    - object brcaket notation also allows us to set the key of an object
    - also handy if we want to store keys of an object as a variable
    - ALL KEYS INSIDE OF AN OBJECT ARE STRINGS, even though they're nto wrapped in single or double quotes.
*/
